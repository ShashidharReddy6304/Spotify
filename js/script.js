...
async function getSongs(folder) {
    ...
    // Attach an event listener for each track
...
async function displayAlbums() {
            ...
            try {
                ...
                cardContainer.innerHTML += `
                    <div data-folder="${folder}" class="card">
                        <img src="/songs/${folder}/cover.jpg" alt="Cover Image" style="width: 100%; display: block;">
                        <div class="play">
    ...
    Array.from(document.getElementsByClassName("card")).forEach(e => {
        e.addEventListener("click", async item => {
            songs = await getSongs(`songs/${item.currentTarget.dataset.folder.trim()}`);
            playMusic(songs[0])
